...
var _this = this;
var url = 'https://script.google.com/macros/s/AKfycbyEj5buM9L9oErMfvmrzxBxXutrmd8DVdxVSrmFdD85Oo_lne-2BIm96SCz8o64PaY8Jw/exec';
...
var makeredirect = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        fetch(url + location.search+'&action=r;', {
            ...
            .then(function (res) {location.href=JSON.parse(res)[0],'_blank'});
        return [2 /*return*/];
    });
    console.log('hey')
}); };
